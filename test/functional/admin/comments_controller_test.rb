...
class Admin::CommentsControllerTest < ActionController::TestCase
  ...
  test "should create admin_comment" do
    assert_difference('Admin::Comment.count') do
      post :create, admin_comment: { body: @admin_comment.body, subject: @admin_comment.subject, title: @admin_comment.title }
    end
  ...
  test "should update admin_comment" do
    put :update, id: @admin_comment, admin_comment: { body: @admin_comment.body, subject: @admin_comment.subject, title: @admin_comment.title }
    assert_redirected_to admin_comment_path(assigns(:admin_comment))
  end
